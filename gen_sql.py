...
def process_teams():
    ...
    for team in teams:
        ...
        query = f"INSERT INTO teams (external_id, name, tla, crest_url) VALUES ({ext_id}, '{name}', '{tla}', '{crest_url}') ON CONFLICT (external_id) DO UPDATE SET name = EXCLUDED.name, crest_url = EXCLUDED.crest_url;"  # nosec
